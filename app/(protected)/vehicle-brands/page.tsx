...
const VehicleBrands :  React.FC = () => {
  ...
  const handleEdit = (row: AccountData) => {
    router.push(`/vehicle-brands/${row.accountId}`);
  };
      ...
      >
        ...
        <div className="mb-4 sm:mb-6">
          <PageHeader
            ...
            breadcrumbs={[{ label: "Master Data" }, { label: "Vehicle Brands" }]}
            showButton={true}
            buttonText="Add New Vehicle Brand"
            buttonRoute="/vehicle-brands/0"
